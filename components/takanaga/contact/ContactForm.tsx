        ...
        <form onSubmit={handleSubmit} noValidate aria-label="お問い合わせフォーム">
          <div className="space-y-6">
            <div>
              ...
              <input id="name" name="name" type="text" className="tkn-input" required autoComplete="name" placeholder="山田 太郎" />
            </div>
            ...
            <div>
              ...
              <input id="phone" name="phone" type="tel" className="tkn-input" required autoComplete="tel" placeholder="090-1234-5678" />
            </div>
            ...
            <div>
              ...
              <input id="email" name="email" type="email" className="tkn-input" required autoComplete="email" placeholder="example@email.com" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input id="city" name="city" type="text" className="tkn-input" required placeholder="岐阜市" />
              </div>
            </div>
            ...
            <div>
              ...
              <input id="address" name="address" type="text" className="tkn-input" autoComplete="street-address" placeholder="丁目・番地（現地調査をご希望の場合）" />
            </div>
            ...
            <div>
              ...
              <input id="budget" name="budget" type="text" className="tkn-input" placeholder="例：50万円前後" />
            </div>

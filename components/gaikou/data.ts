...
// 保証期間は外構工事業界で一般的な目安（土間コンクリート・ブロック塀・フェンス・門扉などの
// 構造物は2年、芝生・植栽の枯れ保証は半年が業界標準）を採用。既製品はメーカー保証に準じる。
export const warrantyItems: WarrantyItem[] = [
  ...
  { iconKey: "calendar-check", title: "保証期間の目安", body: "土間コンクリート・ブロック塀・フェンス・門柱などの施工箇所は2年保証。芝生・植栽の枯れ保証は半年です。使用商品によって異なる場合は、お見積もり時にご説明します。" },
];
...
export const paymentInfoItems: PaymentInfoItem[] = [
  { iconKey: "banknote", title: "現金でのお支払いに対応", body: "現金でのお支払いをお受けしています。銀行振込でのお支払いも可能です。" },
  { iconKey: "circle-dollar-sign", title: "着工前：工事代金の20%", body: "ご契約後、着工前に工事代金の20%をお支払いいただきます。" },
  { iconKey: "check-circle-2", title: "完了後：残り80%", body: "施工完了・仕上がりのご確認後に、残りの80%をお支払いいただきます。" },
  { iconKey: "landmark", title: "リフォームローンのご相談も可能", body: "銀行のリフォームローンをご希望の場合もご相談いただけます。詳しくはお問い合わせください。" },
];
...
export const faqs: FaqItem[] = [
  ...
  { q: "支払い方法とタイミングを教えてください", a: "現金でのお支払いに対応しています（銀行振込も可）。着工前に工事代金の20%、施工完了後に残り80%をお支払いいただく分割払いです。詳しくは契約時にご説明します。" },

...
export const HERO_IMAGE: {
  ...
  alt:
    "建設業に特化。下請けから、選ばれる元請けへ。集客出来るホームページ制作。" +
    "最短3日で集客。1ヶ月で0件から22件。制作して終わりではなく、問い合わせ獲得まで設計。全額返金保証。" +
    "※当社支援実績。成果を保証するものではありません。※返金保証には適用条件があります。",
...
export const FAQS = [
  ...
  {
    q: "全額返金保証には条件がありますか？",
    a: "はい。集客強化プランとMAXプランが対象で、適用条件、対象期間、お客様にご協力いただく事項などがあります。詳細はご契約前に書面でご案内します。",
  },
] as const;

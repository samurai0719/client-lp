...
export const heroContent = {
  mobileImage: "/images/gaiko-review/fv-mobile.png",
  desktopImage: "/images/gaiko-review/fv-desktop.png",
  mobileWidth: 941,
  mobileHeight: 1672,
  desktopWidth: 1672,
  desktopHeight: 941,
...
export const introContent = {
  ...
  paragraphs: [
    "私たちが外構リフォームを考え始めたきっかけは、駐車場の使いにくさでした。",
    "雨の日は足元が汚れやすく、雑草や砂利の手入れも負担になっていました。カーポートもなかったため、買い物から帰ったときや子どもを車へ乗せるときに不便を感じることも増えていました。",
    "最初は外構工事の相場も、どの会社へ頼めばいいのかも分かりませんでした。",
    "そこで、まずは複数の会社から見積もりを取ることにしました。",
  ],
};
...
export const comparisonContent = {
  heading: "同じような工事でも、見積もり金額に大きな差がありました",
  ...
  resultNote:
    "今回の私たちのケースでは、同等の希望内容で比較した結果、最も高い見積もりとの差が50万円以上ありました。",
  disclaimer:
  ...
  items: [
    {
      ...
      body: "営業担当者から現場担当者へ伝言されるのではなく、駐車台数、カーポートの幅、動線、予算などを直接相談できました。",
    },
    {
      number: "02",
      title: "不要な工事を減らせる",
      body: "見栄えだけではなく、実際の暮らし方に合わせて必要な工事と不要な工事を整理してもらえました。",
    },
    {
      number: "03",
      title: "見積もりの理由が分かりやすい",
      body: "材料費、施工費、撤去費、残土処分費など、どこに費用がかかるのかを確認しやすかったです。",
    },
  ] as DirectReason[],
};

export const chosenReasonsContent = {
  heading: "私たちが最終的に高長建設さんを選んだ理由",
  items: [
    "最初から施工内容の説明が具体的だった",
    "予算内で優先順位を考えてくれた",
    "駐車のしやすさまで考えて提案してくれた",
    "質問に対する返答が分かりやすかった",
    "公式サイトのAIシミュレーションで、完成イメージを事前に確認できた",
  ],
};

// 公式サイトで使えるAIシミュレーションのPR用コンテンツ
export const simulatorContent = {
  heading: "完成イメージはAIシミュレーションでも確認できます",
  body: "高長建設の公式サイトでは、写真とAIを使って外構の完成イメージを事前に確認できるシミュレーションが公開されています。私たちも打ち合わせの前に試してみて、仕上がりのイメージをすり合わせるのに役立ちました。",
  ...
  items: [
    {
      ...
      answer:
        "見積もりの内訳について事前に確認し、想定外の工事が必要になった場合の進め方を聞いておくことで、不安を減らすことができました。",
    },
    {
      question: "完成後の見た目が想像と違わないか",
      answer:
        "プラン図や使用する材料の説明に加えて、公式サイトのAIシミュレーションで完成イメージを事前に確認できたことで、仕上がりのイメージをすり合わせることができました。",
    },
    {
      question: "工事中に車をどこへ止めるのか",
      answer:
        "工事期間中の駐車スペースについて事前に相談し、段取りを確認しておくことで当日困ることがありませんでした。",
    },
    {
      question: "近所へ迷惑がかからないか",
      answer:
        "工事の音や車両の出入りについて事前に説明を受けたことで、近隣への配慮についても確認できました。",
    },
    {
      question: "工事後に不具合が起きないか",
      answer:
        "完成後の確認の流れについて事前に説明を受け、気になる点はその場で相談できる体制であることを確認しました。",
    },
  ] as ConcernItem[],
};
...
export const flowContent = {
  ...
  steps: [
    ...
    { step: 4, title: "プランと見積もりの提案", description: "内訳が分かる見積もりとプランを提示してもらいます。" },
...
export const notFitForContent = {
  ...
  paragraphs: [
    ...
    "そのため、写真だけで正確な金額を判断するのではなく、まずは現地を確認してもらうことをおすすめします。",
  ],
};
  ...
  items: [
    {
      ...
      answer: "無料相談・現地調査に対応しています（詳細な条件は高長建設へご確認ください）。",
      confirmed: false,
    },
    {
      id: "gr-faq-02",
      question: "見積もりだけでも相談できますか？",
      answer: "見積もりのみのご相談も可能です。契約を強くお急がせすることはありません。",
      confirmed: false,
    },
    {
      id: "gr-faq-03",
    ...
    },
    {
      ...
      answer: "はい、公式サイトでAIシミュレーションを使って完成イメージを確認できます。相談前のイメージ合わせにも活用できます。",
      confirmed: false,
    },
  ] as FaqItem[],
};
...
export const finalSummaryContent = {
  ...
  paragraphs: [
    ...
    "高長建設さんへ直接相談したことで、希望と予算の両方を整理しながら、私たちの家に合った内容を考えてもらえました。",
    "まだ工事を決めていない方も、まずは自宅の場合にどのような工事ができるのかを相談してみるとよいと思います。",
  ],
};

export const ctaContent = {
  heading: "自宅の外構について、高長建設に相談してみる",
...
export const seoContent = {
  ...
  ogImage: "/images/gaiko-review/fv-desktop.png",

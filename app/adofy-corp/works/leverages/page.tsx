...
export const metadata = corpMetadata("works/leverages");

export default function LeveragesWorksPage() {
  return (
    <>
      <CorpStructuredData breadcrumb={worksBreadcrumb("works/leverages")} />
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="relative mt-10 overflow-hidden rounded-[2rem] border border-border-soft bg-white p-6 shadow-soft md:p-10">
            ...
            <p className="mt-6 leading-8 text-ink-soft">
              転職・人材領域における広告運用・LP改善・クリエイティブ制作の実績を掲載予定です。
              後から制作したCR、広告バナー、LP、改善内容などをここに追加できます。
            </p>

            <div className="mt-10 grid gap-5 md:grid-cols-2">
              <WorkImage
                imageBase="/images/works/leverages/creative"
                alt="レバレジーズグループ 広告クリエイティブ"
                placeholderLabel="CR画像・動画をここに配置"
              />
              <WorkImage
                imageBase="/images/works/leverages/lp"
                alt="レバレジーズグループ LPスクリーンショット"

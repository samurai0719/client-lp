...
export const metadata = corpMetadata("works/rizap-golf");

export default function RizapGolfWorksPage() {
  return (
    <>
      <CorpStructuredData breadcrumb={worksBreadcrumb("works/rizap-golf")} />
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="relative mt-10 overflow-hidden rounded-[2rem] border border-border-soft bg-white p-6 shadow-soft md:p-10">
            ...
            <p className="mt-6 leading-8 text-ink-soft">
              ゴルフスクール領域における広告運用・LP改善・クリエイティブ制作の実績を掲載予定です。
              後から制作したCR、広告バナー、LP、改善内容などをここに追加できます。
            </p>

            <div className="mt-10 grid gap-5 md:grid-cols-2">
              <WorkImage
                imageBase="/images/works/rizap-golf/creative"
                alt="RIZAP GOLF 広告クリエイティブ"
                placeholderLabel="CR画像・動画をここに配置"
              />
              <WorkImage
                imageBase="/images/works/rizap-golf/lp"
                alt="RIZAP GOLF LPスクリーンショット"

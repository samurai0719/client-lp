...
export default function OfficeWellnessLP() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden" style={{ background: '#f9f7f2', color: '#1c1917' }}>
      ...
      <section
        style={{
          background: 'linear-gradient(135deg, #fdfcf8 0%, #f5f0e8 50%, #ede4d0 100%)',
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: 'repeating-linear-gradient(0deg,#8b6d3e 0,#8b6d3e 1px,transparent 1px,transparent 60px),repeating-linear-gradient(90deg,#8b6d3e 0,#8b6d3e 1px,transparent 1px,transparent 60px)',
          }}
        />
        {/* glow orbs */}
        <div className="pointer-events-none absolute -top-24 right-0 h-96 w-96 rounded-full opacity-20" style={{ background: 'radial-gradient(circle, #d4ad72 0%, transparent 70%)' }} />
        <div className="pointer-events-none absolute bottom-0 left-0 h-64 w-64 rounded-full opacity-15" style={{ background: 'radial-gradient(circle, #c9a96e 0%, transparent 70%)' }} />

        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-16 md:px-10 lg:grid-cols-2 lg:items-center lg:py-28">
          {/* Left */}
          <div>
            <div
              className="mb-6 inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm font-semibold"
              style={{ background: '#fff', border: '1px solid #d4ad72', color: '#8a6d3e' }}
            >
              <span
                className="inline-block h-2 w-2 rounded-full"
                style={{ background: 'linear-gradient(135deg, #d4ad72, #8a6d3e)' }}
              />
              法人向け 出張ウェルネスサービス
            </div>

            <h1 className="max-w-xl text-4xl font-bold leading-tight tracking-tight md:text-5xl lg:text-6xl" style={{ color: '#1c1917' }}>
              働く人の体を、
              <br />
              <span
                style={{
                  background: 'linear-gradient(90deg, #8a6d3e 0%, #c9a96e 50%, #8a6d3e 100%)',
            ...
            <p className="mt-6 max-w-lg text-base leading-8 md:text-lg" style={{ color: '#57534e' }}>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#contact"
                className="wellness-cta-btn"
              >
                <span className="wellness-cta-btn-inner">
                  <span className="block text-sm font-semibold opacity-80">無料相談・お見積もり</span>
                  <span className="block text-base font-bold">まずはお問い合わせ →</span>
                </span>
              ...
              <a
                ...
                style={{ background: '#fff', border: '1.5px solid #d4ad72', color: '#8a6d3e', boxShadow: '0 2px 12px rgba(180,140,80,0.10)' }}
              >
                導入の流れを見る
              </a>
            </div>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {['初期費用0円から相談可能', '最短2週間で導入', '健康経営対応実績あり'].map((tag) => (
                <span
                  ...
                  style={{ background: 'rgba(255,255,255,0.75)', border: '1px solid #e5ddd0', color: '#78716c' }}
                >
                  ✓ {tag}
                </span>
              ))}
          ...
          <div className="relative">
            <div
              ...
              style={{
                background: 'linear-gradient(180deg,#fdfcf8 0%,#f0e9d8 100%)',
                border: '1.5px solid #ddd5c0',
                boxShadow: '0 32px 80px rgba(140,110,60,0.14), 0 2px 0 rgba(255,255,255,0.8) inset',
                padding: '20px',
              }}
            >
              <div
                className="flex aspect-[4/3] flex-col items-center justify-center rounded-2xl text-center"
                style={{ background: 'linear-gradient(160deg,#faf7f0 0%,#ede6d5 100%)', border: '2px dashed #c9b48a' }}
              >
                <div className="mb-3 text-5xl opacity-30">📷</div>
                <p className="text-base font-semibold" style={{ color: '#a08060' }}>写真挿入エリア</p>
                <p className="mt-1 text-sm" style={{ color: '#b8a485' }}>施術風景 / オフィス環境 / スタッフ写真</p>
              </div>
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    ...
                    style={{ background: '#fff8ee', border: '1px solid #e8d9bc' }}
                  >
                    <div className="text-lg font-bold" style={{ color: '#8a6d3e' }}>{s.val}</div>
                    <div className="text-xs" style={{ color: '#a09070' }}>{s.label}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* floating badge */}
            <div
              className="absolute -left-4 top-8 rounded-2xl px-4 py-3 text-center shadow-lg"
              style={{ background: '#fff', border: '1px solid #e8d8b8' }}
            >
              <div className="text-xl font-bold" style={{ color: '#8a6d3e' }}>★ 4.9</div>
              <div className="text-xs" style={{ color: '#a09070' }}>導入企業<br />評価平均</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_0.95fr] lg:items-start">
          ...
          >
            ...
            <div className="mt-7 space-y-3">
              ...
              >
                <span className="wellness-cta-btn-inner">
                  <span className="block text-base font-bold">無料でお問い合わせする →</span>
                </span>
                <span className="wellness-cta-shine" aria-hidden="true" />
              </a>

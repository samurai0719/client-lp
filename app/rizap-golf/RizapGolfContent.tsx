...
const diagnosisImage = 'https://static.wixstatic.com/media/5ebda9_3a1b6944157b4ee89b8c2af46f2ce857~mv2.png';
const lessonImage = 'https://static.wixstatic.com/media/5ebda9_86fe0cab5d744de589a3c190a9926a0a~mv2.png';
...
export default function RizapGolfContent() {
  return (
